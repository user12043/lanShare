...
/**
 * Thanks to Leandro and Jamaslab
 * https://stackoverflow.com/q/28427339/7541163
 * https://stackoverflow.com/a/28479001/7541163
 * <p>
...
//                Logger.info("Return full file");
                ...
                Range.copy(input, sos, length, full.start, full.length);
...
//                Logger.info("Return 1 part of file : from (" + r.start + ") to (" + r.end + ")");
                ...
                Range.copy(input, sos, length, r.start, r.length);
